<script lang="ts">
	...
	onMount(() => {
		...
		async function mountChart() {
			const [{ init, use }, { LineChart: EChartsLineChart }, { GridComponent, LegendComponent, TooltipComponent }, { CanvasRenderer }] =
				await Promise.all([
					import('echarts/core'),
			...
			use([EChartsLineChart, GridComponent, LegendComponent, TooltipComponent, CanvasRenderer]);
